...
def default_categorical(input_shape=(120, 160, 3), roi_crop=(0, 0)):
    ...
    if input_shape[0] > 32:
        ...
        x = Convolution2D(64, (3, 3), strides=(1, 1), activation='elu', name="conv2d_3")(x)
    if input_shape[0] > 64:
        x = Convolution2D(64, (3, 3), strides=(2, 2), activation='elu', name="conv2d_4")(x)
    ...
    x = Dense(100, activation='elu', name="fc_1")(x)
    x = Dropout(drop)(x)
    x = Dense(50, activation='elu', name="fc_2")(x)
    x = Dropout(drop)(x)
...
def default_latent(num_outputs, input_shape):
    ...
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='elu', name="conv2d_2")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='elu', name="conv2d_3")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (3, 3), strides=(1, 1), activation='elu', name="conv2d_4")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (3, 3), strides=(1, 1), activation='elu', name="conv2d_5")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (3, 3), strides=(2, 2), activation='elu', name="conv2d_6")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (3, 3), strides=(2, 2), activation='elu', name="conv2d_7")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(10, (1, 1), strides=(2, 2), activation='elu', name="latent")(x)
...
class KerasLYWCNN(KerasPilot):
    ...
    def __init__(self, num_outputs=2, input_shape=(120, 160, 3), roi_crop=(0, 0), *args, **kwargs):
        ...
        self.model = LYWCNN(num_outputs, input_shape, roi_crop)
        self.compile()
...
def LYWCNN(num_outputs, input_shape=(120, 160, 3), roi_crop=(0, 0)):
    drop = 0.1
    input_shape = adjust_input_shape(input_shape, roi_crop)
    img_in = Input(shape=input_shape, name='img_in')
    x = img_in
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='relu', name="conv2d_1")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (5, 5), strides=(2, 2), activation='relu', name="conv2d_2")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (5, 5), strides=(2, 2), activation='relu', name="conv2d_3")(x)
    x = Dropout(drop)(x)
