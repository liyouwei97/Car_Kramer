...
def default_categorical(input_shape=(120, 160, 3), roi_crop=(0, 0)):
    ...
    x = img_in
    x = Convolution2D(24, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_1")(x)
    # 24 features, 5 pixel x 5 pixel kernel (convolution, feauture) window, 2wx2h stride, hard_sigmoid activation
    x = Dropout(drop)(x)
    ...
    # 32 features, 5px5p kernel window, 2wx2h stride, hard_sigmoid activatiion
    x = Dropout(drop)(x)
    # Randomly drop out (turn off) 10% of the neurons (Prevent overfitting)
    if input_shape[0] > 32:
        x = Convolution2D(64, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_3")(x)
        # 64 features, 5px5p kernal window, 2wx2h stride, hard_sigmoid
    else:
        x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_3")(x)
        # 64 features, 5px5p kernal window, 2wx2h stride, hard_sigmoid
    if input_shape[0] > 64:
        x = Convolution2D(64, (3, 3), strides=(2, 2), activation='hard_sigmoid', name="conv2d_4")(x)
        # 64 features, 3px3p kernal window, 2wx2h stride, hard_sigmoid
    elif input_shape[0] > 32:
        x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_4")(x)
        # 64 features, 3px3p kernal window, 2wx2h stride, hard_sigmoid
    x = Dropout(drop)(x)
    # Randomly drop out (turn off) 10% of the neurons (Prevent overfitting)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
    # 64 features, 3px3p kernal window, 1wx1h stride, hard_sigmoid
    x = Dropout(drop)(x)
    # Randomly drop out (turn off) 10% of the neurons (Prevent overfitting)
    # Possibly add MaxPooling (will make it less sensitive to position in image).  Camera angle fixed, so may not to be needed

    x = Flatten(name='flattened')(x)  # Flatten to 1D (Fully connected)
    x = Dense(100, activation='hard_sigmoid', name="fc_1")(x)  # Classify the data into 100 features, make all negatives 0
    x = Dropout(drop)(x)  # Randomly drop out (turn off) 10% of the neurons (Prevent overfitting)
    x = Dense(50, activation='hard_sigmoid', name="fc_2")(x)  # Classify the data into 50 features, make all negatives 0
...
#     x = Dense(100, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
#     x = Dense(50, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
#     outputs = []
...
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_6")(x)
#     x = Dropout(drop)(x)
#     x = Flatten(name='flattened')(x)
#     x = Dense(100, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
...
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_6")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_7")(x)
#     x = Dropout(drop)(x)
#     x = Flatten(name='flattened')(x)
#     x = Dense(100, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
...
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_7")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_8")(x)
#     x = Dropout(drop)(x)
#     x = Flatten(name='flattened')(x)
#     x = Dense(100, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
...
#     x = Convolution2D(64, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_3")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(128, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_4")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
#     x = Dropout(drop)(x)
#     # x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_6")(x)
...
#     x = Convolution2D(64, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_3")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(192, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_4")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(192, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(192, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_6")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(192, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_7")(x)
#     x = Dropout(drop)(x)
#     x = Flatten(name='flattened')(x)
#     x = Dense(100, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
...
#     img_in = Input(shape=input_shape, name='img_in')
#     x = img_in
#     x = Convolution2D(32, (5, 5), strides=(1, 1), activation='hard_sigmoid', name="conv2d_1")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(32, (5, 5), strides=(1, 1), activation='hard_sigmoid', name="conv2d_2")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(64, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_3")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(64, (3, 3), strides=(2, 2), activation='hard_sigmoid', name="conv2d_4")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(128, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
#     x = Dropout(drop)(x)
#     x = Convolution2D(128, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_6")(x)
#     x = Dropout(drop)(x)
#     x = Flatten(name='flattened')(x)
#     x = Dense(100, activation='hard_sigmoid')(x)
#     x = Dropout(drop)(x)
...
def default_imu(num_outputs, num_imu_inputs, input_shape):
    ...
    x = img_in
    x = Convolution2D(24, (5, 5), strides=(2, 2), activation='hard_sigmoid')(x)
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='hard_sigmoid')(x)
    x = Convolution2D(64, (3, 3), strides=(2, 2), activation='hard_sigmoid')(x)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid')(x)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid')(x)
    x = Flatten(name='flattened')(x)
    x = Dense(100, activation='hard_sigmoid')(x)
    x = Dropout(.1)(x)
    ...
    y = imu_in
    y = Dense(14, activation='hard_sigmoid')(y)
    y = Dense(14, activation='hard_sigmoid')(y)
    y = Dense(14, activation='hard_sigmoid')(y)

    z = concatenate([x, y])
    z = Dense(50, activation='hard_sigmoid')(z)
    z = Dropout(.1)(z)
    z = Dense(50, activation='hard_sigmoid')(z)
    z = Dropout(.1)(z)
...
def default_bhv(num_outputs, num_bvh_inputs, input_shape):
    ...
    x = Convolution2D(24, (5, 5), strides=(2, 2), activation='hard_sigmoid')(x)
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='hard_sigmoid')(x)
    x = Convolution2D(64, (5, 5), strides=(2, 2), activation='hard_sigmoid')(x)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid')(x)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid')(x)
    x = Flatten(name='flattened')(x)
    x = Dense(100, activation='hard_sigmoid')(x)
    ...
    y = bvh_in
    y = Dense(num_bvh_inputs * 2, activation='hard_sigmoid')(y)
    y = Dense(num_bvh_inputs * 2, activation='hard_sigmoid')(y)
    y = Dense(num_bvh_inputs * 2, activation='hard_sigmoid')(y)

    z = concatenate([x, y])
    z = Dense(100, activation='hard_sigmoid')(z)
    z = Dropout(.1)(z)
    z = Dense(50, activation='hard_sigmoid')(z)
    z = Dropout(.1)(z)
...
def default_loc(num_locations, input_shape):
    ...
    z = Dense(50, activation='hard_sigmoid')(x)
    z = Dropout(drop)(z)
...
def rnn_lstm(seq_length=3, num_outputs=2, image_shape=(120, 160, 3)):
    ...
    x = Sequential()
    x.add(TD(Convolution2D(24, (5, 5), strides=(2, 2), activation='hard_sigmoid'), input_shape=img_seq_shape))
    x.add(TD(Dropout(drop_out)))
    x.add(TD(Convolution2D(32, (5, 5), strides=(2, 2), activation='hard_sigmoid')))
    x.add(TD(Dropout(drop_out)))
    x.add(TD(Convolution2D(32, (3, 3), strides=(2, 2), activation='hard_sigmoid')))
    x.add(TD(Dropout(drop_out)))
    x.add(TD(Convolution2D(32, (3, 3), strides=(1, 1), activation='hard_sigmoid')))
    x.add(TD(Dropout(drop_out)))
    x.add(TD(MaxPooling2D(pool_size=(2, 2))))
    x.add(TD(Flatten(name='flattened')))
    x.add(TD(Dense(100, activation='hard_sigmoid')))
    x.add(TD(Dropout(drop_out)))
    ...
    x.add(Dropout(.1))
    x.add(Dense(128, activation='hard_sigmoid'))
    x.add(Dropout(.1))
    x.add(Dense(64, activation='hard_sigmoid'))
    x.add(Dense(10, activation='hard_sigmoid'))
...
def default_latent(num_outputs, input_shape):
    ...
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_2")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_3")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_4")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (3, 3), strides=(2, 2), activation='hard_sigmoid', name="conv2d_6")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (3, 3), strides=(2, 2), activation='hard_sigmoid', name="conv2d_7")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(10, (1, 1), strides=(2, 2), activation='hard_sigmoid', name="latent")(x)
    ...
    x = Flatten(name='flattened')(x)
    x = Dense(256, activation='hard_sigmoid')(x)
    x = Dropout(drop)(x)
    x = Dense(100, activation='hard_sigmoid')(x)
    x = Dropout(drop)(x)
    x = Dense(50, activation='hard_sigmoid')(x)
...
def LYW_CNN(num_outputs, input_shape=(120, 160, 3), roi_crop=(0, 0)):
    ...
    img_in = Input(shape=input_shape, name='img_in')
    x = img_in
    x = Convolution2D(28, (5, 5), strides=(2, 2), activation='hard_sigmoid', name="conv2d_1")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(32, (5, 5), strides=(1, 1), activation='hard_sigmoid', name="conv2d_2")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (5, 5), strides=(1, 1), activation='hard_sigmoid', name="conv2d_3")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_4")(x)
    x = Dropout(drop)(x)
    x = Convolution2D(64, (3, 3), strides=(1, 1), activation='hard_sigmoid', name="conv2d_5")(x)
...
#         img_in = Input(shape=input_shape, name='img_in')
#         x = img_in
#         x = Dense(100, activation='hard_sigmoid', name='dense_1')(x)
#         x = Dropout(drop)(x)
#         x = Dense(50, activation='hard_sigmoid', name='dense_2')(x)
#         x = Dropout(drop)(x)
...
#         z = Dense(50, activation='hard_sigmoid', name='dense_3')(z)
#         z = Dropout(drop)(z)
#         z = Dense(50, activation='hard_sigmoid', name='dense_4')(z)
#         z = Dropout(drop)(z)
